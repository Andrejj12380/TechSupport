                                ...
                                <tr key={ticket.id} className="hover:bg-slate-50/50 transition-colors group">
                                        ...
                                        <div className="flex items-center gap-3">
                                            ...
                                            <div>
                                                ...
                                                <div className="text-[10px] font-bold text-slate-400 uppercase tracking-tighter">
                                                    {getStatusLabel(ticket.status)} {ticket.resolved_at ? ` • Решено: ${new Date(ticket.resolved_at).toLocaleString('ru-RU')}` : ''}
                                                </div>
                                            </div>
                                        </div>
                                    </td>
                                    ...
                                    <td className="px-6 py-5 text-right">
                                        <div className="flex items-center justify-end gap-2 opacity-0 group-hover:opacity-100 transition-opacity">
                                            ...
                                            <button className="p-2 text-slate-400 hover:text-[#FF5B00] hover:bg-[#FF5B00]/5 rounded-xl transition-all">
                            ...
                            <form onSubmit={handleSubmit} className="space-y-6">
                                <div className="grid grid-cols-2 gap-6">
                                    <div className="space-y-2">
                                        ...
                                        <select
                                            ...
                                            className="w-full px-5 py-3.5 bg-slate-50 border-2 border-transparent focus:border-[#FF5B00] rounded-2xl outline-none font-bold text-slate-700 transition-all cursor-pointer"
                                        >
                                ...
                                <div className="grid grid-cols-2 gap-6">
                                    <div className="space-y-2">
                                        ...
                                        <input
                                            ...
                                            className="w-full px-5 py-3.5 bg-slate-50 border-2 border-transparent focus:border-[#FF5B00] rounded-2xl outline-none font-bold text-slate-700 transition-all"
                                ...
                                <div className="space-y-2">
                                    ...
                                    <textarea
                                        ...
                                        className="w-full h-32 px-5 py-4 bg-slate-50 border-2 border-transparent focus:border-[#FF5B00] rounded-3xl outline-none font-medium text-slate-700 transition-all resize-none"
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                    <div className="space-y-2">
                                        ...
                                        <textarea
                                            ...
                                            className="w-full h-48 px-5 py-4 bg-slate-50 border-2 border-transparent focus:border-[#FF5B00] rounded-3xl outline-none font-medium text-slate-700 transition-all resize-none"
                                    ...
                                    <div className="flex flex-col sm:flex-row items-end justify-end gap-3">
                                        ...
                                        <div className="flex gap-3">
                                            <button
                                                ...
                                                disabled={isSaving}
                                                className="px-6 py-4 rounded-2xl font-bold text-slate-500 hover:bg-slate-50 transition-all disabled:opacity-50 disabled:cursor-not-allowed"
                                            >
                                                Отмена
                                            </button>
                                            <button
